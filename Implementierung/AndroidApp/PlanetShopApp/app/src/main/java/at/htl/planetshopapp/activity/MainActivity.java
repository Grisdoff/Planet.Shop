...
import at.htl.planetshopapp.fragment.LoginFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadLoginFragment() {
        getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.main_container, LoginFragment.newInstance()).commit();
    }
}
